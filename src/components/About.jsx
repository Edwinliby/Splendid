    ...
    <div className="flex flex-col lg:flex-row relative font-montserrat">
      ...
      <div className="relative lg:sticky z-[2] bg-transparent top-0 left-0 flex flex-col lg:w-[70%] h-fit lg:h-[100vh] justify-center p-4 lg:pl-16 gap-4">
        ...
        <div className="flex lg:flex-col  justify-center items-center gap-4">
          ...
          <Link href="/about"
            className="bg-[#FF9D42] hidden lg:block text-center text-white w-fit z-[2] border-[2.5px] hover:border-gray/50 transition-all duration-300 ease-in-out font-medium font-montserrat text-[.7rem] md:text-[1rem] px-4 py-2 rounded-full">
            More Details
          </Link>
        </div>
      ...
      <div className="z-[3] flex flex-col lg:pr-12 w-full">
        {
          content.map((item) => (
            <motion.div
              ...
              <p className="text-black/80 pt-4 sm:text-[1.1rem] text-justify">
                {item.para}
                <br />
                <br />
