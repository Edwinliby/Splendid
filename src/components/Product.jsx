...
export default function Product() {
  return (
    <div className='relative lg:top-[-5rem] w-full bg-royal_blue font-montserrat flex flex-col justify-center gap-14 pb-8'>
      <div className='h-fit text-white z-[2] px-[1rem] lg:px-[4rem] flex justify-between items-center w-full relative lg:top-[-2.5rem]'>
        <h1 className='font-semibold sm:text-[1.5rem] lg:text-5xl'>Our Products <br />& Equipment</h1>
